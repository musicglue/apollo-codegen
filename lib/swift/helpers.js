...
class Helpers {
    ...
    mapExpressionForType(type, makeExpression, expression, structName) {
        ...
        if (type instanceof graphql_1.GraphQLList) {
            ...
            return `${expression}.flatMap { ${makeClosureSignature(this.typeNameFromGraphQLType(type, structName, false))} ${makeExpression('value')} }`;
        }
        else {
...
function makeClosureSignature(typeName) {
